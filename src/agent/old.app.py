...
from src.agent.tools import calculator, now_time, manual_search, set_retriever, system_stats
...
def get_app():
    ...
    llm_act = llm.bind_tools([calculator, now_time, manual_search, system_stats])
    ...
    tool_node = ToolNode([calculator, now_time, manual_search, system_stats])
